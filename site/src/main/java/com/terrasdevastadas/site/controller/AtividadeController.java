...
//    }
    ...
    public ResponseEntity<Atividade> updateAtividade(@RequestBody AtividadeDTO atividadeDTO, @PathVariable Long id){

        return new ResponseEntity<>(atividadeService.updateAtividade(atividadeDTO, id), HttpStatus.OK);
    }
